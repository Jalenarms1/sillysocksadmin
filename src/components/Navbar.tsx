    ...
    <nav className="flex z-50 items-center justify-between flex-wrap bg-zinc-300 px-4 py-2 shadow-sm shadow-red-900 relative">
      ...
      >
        ...
        {session && session?.user?.email === 'sillysocksandmore@gmail.com' && <div className="text-sm lg:flex-grow ">
          ...
          <Link href="/product" className="block mt-4 lg:inline-block lg:mt-0 text-gray-200 shadow-md shadow-zinc-500 bg-gradient-to-b from-[#3d0c0c] to-[#3f1a1a] px-3 w-[90%] p-1 rounded-full hover:bg-red-800 active:bg-[#3d0c0c] hover:text-white">
              Add Product
